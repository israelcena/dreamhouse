...
@section('body')
    <section class="relative text-gray-600 body-font mb-12 bg-gradient-to-br from-yellow-300 overflow-clip">
        <div
            class="mx-full flex flex-col px-1 justify-center items-center min-h-[70vh]">
            <img
            class="absolute -z-10 h-fit object-cover"
            src="{{ url('/') }}/images/main-page/main-photo.jpg"
            alt="main photo">
            <div class="w-full md:w-2/3 flex flex-col justify-center items-center text-center bg-white p-6 rounded-lg min-h-[35vh]">
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Vamos Encontrar Sua Casa dos
                    Sonhos</h1>
                <p class="mb-4 leading-relaxed">As melhores casas, os melhores corretores, os melhores designers e arquitetos com a melhor plataforma.</p>
        ...
        <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div
                ...
                <p class="mb-8 leading-relaxed">DreamHouse está construindo um mercado colaborativo para conectar pessoas,
                  vendedores, arquitetos, designers, agentes e equipá-los com as ferramentas certas em cada etapa do processo.
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap w-full mb-20">
                ...
                <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Aqui está a seleção das casas mais bem avaliadas!</p>
            </div>

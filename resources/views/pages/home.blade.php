                    ...
                    <div class="flex w-full justify-center items-end">
                        <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4 md:w-full text-left">
                            ...
                            <input type="search" id="search" name="search"
                                   ...
                                   placeholder="Ex: RJ, Rua Almirante Barroso, Apartamento..."/>
                        </div>
                        <button
    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
            <div
                ...
                <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Conectamos Corretores
                    <br class="hidden lg:inline-block">Compradores e Vendedores.
                </h1>
                <p class="mb-8 leading-relaxed">DreamHouse está construindo um mercado colaborativo de última geração
                    para conectar compradores, vendedores e agentes e equipá-los com as ferramentas certas em cada etapa
                    do processo. Com mais de um milhão de listagens e recursos inovadores, vamos ajudá-lo a tomar a
                    decisão mais informada, seja comprando sua casa dos sonhos ou vendendo um imóvel. Estamos
                    redefinindo o processo de compra de casas.</p>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap w-full mb-20">
                ...
                <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Uma seleção com as melhores casas! Aproveite e
                    veja mais!</p>
            </div>

        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('dashboard.update', $homeForRent->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 gap-2">
                            <div class="form-group mb-6">
                                ...
                                @if($homeForRent->photo)
                                    <div class="mb-3">
                                        <p class="text-sm text-gray-600 mb-2">Foto atual:</p>
                                        <img src="{{ $homeForRent->photo }}" alt="Foto atual" class="w-48 h-32 object-cover rounded border">
                                    </div>
                                @endif

                                <p class="text-xs text-gray-500 mb-2">Escolha uma das opções abaixo para atualizar a foto:</p>

                                <div class="mb-3">
                                    <label for="photo" class="block text-sm text-gray-600 mb-1">Fazer upload de novo arquivo:</label>
                                    <input type="file"
                                        class="form-control
                                        w-full
                                        block
                                ...
                                <div>
                                    <label for="photo_url" class="block text-sm text-gray-600 mb-1">Informar nova URL da imagem:</label>
                                    <input type="text"
                                        class="form-control
                                        w-full
                                        block

...
@section('footer')
    <div class="fixed-bottom">
        <footer class="d-flex flex-wrap justify-content-between align-items-center px-4 py-3 my-4 border-top">
            <p class="col-md-4 mb-0 text-muted">© 2022 DreamHouse, Inc - Realizando o seu sonho da casa
                própria</p>
            ...
            <ul class="nav col-md-4 justify-content-end">
                ...
                <li class="nav-item"><a href="#" class="nav-link px-2 text-muted">Lançamentos</a></li>
